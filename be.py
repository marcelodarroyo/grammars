...
def be(grammar, rule, deep):
    """
    Generate a list (set) of strings generated by grammar g, starting from rule until
    the given deep. It is based on bounded exhaustive generation.
    """
    if deep == 0:
        return []
    result = []
...
if __name__ == "__main__":
    if len(sys.argv) < 4:
        ...
        print be(grammar, grammar.rules[0], n)
